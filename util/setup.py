...
class Setup(Freezeable):
    ...
    def toString(self):
        ...
        s += str('world.dim').ljust(20) + str(self.world.dim).translate({ord(i): None for i in '[]'}) + '\n'
        s += str('world.box_dim').ljust(20) + str(self.world.box_dim).translate({ord(i): None for i in '[]'}) + '\n'
        ...
        s += str('world.limits').ljust(20) + str(self.world.limits).translate({ord(i): None for i in '[]'}) + '\n\n'
        # rat paramerters
        s += str('rat.color').ljust(20) + str(self.rat.color) + '\n'
        s += str('rat.fov').ljust(20) + str(self.rat.fov).translate({ord(i): None for i in '[]'}) + '\n'
        ...
        s += str('rat.bias').ljust(20) + str(self.rat.bias).translate({ord(i): None for i in '[]'}) + '\n'
    ...
    def fromFile(self, filename):
        ...
        if self.world.type == 'box' or self.world.type == 'circle': self.world.dim = numpy.array(
            [float(s[0]), float(s[1]), float(s[2])])
        if self.world.type == 'star': self.world.dim = numpy.array([float(s[0]), float(s[1]), float(s[2]), float(s[3])])
        if self.world.type == 'T': self.world.dim = numpy.array(
